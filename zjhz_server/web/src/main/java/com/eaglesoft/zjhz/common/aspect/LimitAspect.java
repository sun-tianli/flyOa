...
import com.eaglesoft.zjhz.common.annotation.Limit;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.eaglesoft.zjhz.common.annotation.Limit)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        BaseEnum.LimitType limitType = limitAnnotation.limitType();
        ...
        if (count != null && count.intValue() <= limitCount) {
            ...
            log.error("IP:{} 第 {} 次访问key为 {}，描述为 [{}] 的接口,超出频率限制", ip, count, keys, name);
            //todo 插日志
